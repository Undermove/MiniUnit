...
public sealed class MiniUnitExecutor : ITestExecutor
{
    ...
    public void RunTests(System.Collections.Generic.IEnumerable<string> sources, IRunContext runContext, IFrameworkHandle frameworkHandle)
    {
    ...
    public void RunTests(System.Collections.Generic.IEnumerable<TestCase> tests, IRunContext runContext, IFrameworkHandle frameworkHandle)
    {
        foreach (var group in tests.GroupBy(t => t.Source))
        {
            ...
            foreach (var tc in group)
            {
                ...
                try
                {
                    ...
                    var t = asm.GetType(typeName) ?? throw new InvalidOperationException("Type not found: " + typeName);
                    var m = t.GetMethod(methodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
                            ?? throw new InvalidOperationException("Method not found: " + methodName);

                    var instance = Activator.CreateInstance(t);
                    // Minimal reflection just for lifecycle hooks (cheap)
    ...
    private sealed class CollectingSink : ITestCaseDiscoverySink, IMessageLogger, IFrameworkHandle
    {
        public readonly System.Collections.Generic.List<TestCase> Collected = new();
        ...
        public int LaunchProcessWithDebuggerAttached(string filePath, string workingDirectory, string arguments, System.Collections.Generic.IDictionary<string, string> environmentVariables) => -1;
        public void RecordAttachment(AttachmentSet attachmentSet) { }
        public void RecordAttachments(System.Collections.Generic.IList<AttachmentSet> attachmentSets) { }
